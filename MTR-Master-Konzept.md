...
*Form and media choices*

Workshops

I hope to hold these in physical spaces. Groups sizes ca. 5 - 15 people.  
...
Pattern Language for protopian processes

Here a imagine, on the one hand, a digital wiki-style website which contains the pattern language prototype and can be collaboratively edited. On the other hand, I plan to develop a physical deck of cards, based on the pattern language. The cards can be a tool for thinking/designing in terms of the pattern language, as well as being artifacts that can play a performative role in workshops/happenings. 

*What is the relationship between the practical and the discursive part of my Master Project?*

The discursive part of my project will mainly consist of a digital hypertext (wiki-style), which is designed to also be converted into a printed booklet. In this text, I will attempt to approach the topic of protopian process in a kaleidoscope manner. This means: sketching some theory of the what "protopian processes" can mean; making connections to some existing ideas and works; collecting thoughts on miscellaneous aspects of the topic; including semi-poetic text fragments and possibly images. 

The text will serve as a contextual and theoretical framing of the practical parts of my project. It can be read on its own, however, i.e. independent of the practical part of my project. 
...
- List of research materials
	...
	- Joe Holmes - Hyperpoetry [link](https://www.figma.com/proto/JWfE0wAJDH12zglSuB4bbv/Hyperpoetry?node-id=72%3A4439&viewport=-2293%2C1629%2C0.520870566368103&scaling=min-zoom)
	- Luis Camnitzer - One number is worth one word
	- [[Literary Machines]] by [[Ted Nelson]] #Book 
	- [[The Timeless Way of Building]] by [[Christopher Alexander]] #Book
	- [[The Glass Bead Game]] by [[Hermann Hesse]] #Book 
	- [[As We May Think]] by [[Vannevar Bush]] #Article 
	- [[Staying With The Trouble]] by [[Donna Haraway]] #Book
	- [[Ästhetisches Denken: Kunst als Theoria]] by [[Dieter Mersch]] #Article
	-  [[The Treasure of the Humble]] by [[Maurice Maeterlinck]] #Book
	- [[Category Theory and Life]] by [[Eugenia Cheng]] #Talk
	- [[Collaborating In and Beyond Science]] by [[Sabine Maasen]] #Article
	- [[On the Shortness of Life]] by [[Seneca]] #Book
	-  [[Das Vollkommene Leben]] by [[Michael Hampe]] #Book
	- [[Designing Your LIfe]] by [[Bill Burnett]] and [[Dave Evans]] #Book
	- [[Bioneers 2000 Talk]] by [[William McDonough]] #Talk  | [video](https://www.youtube.com/watch?v=J8EMFaYvH_A)
	- [[Wissenschaft als symbolische Konstruktion des Menschen]] by [[Hermann Weyl]] #Article
